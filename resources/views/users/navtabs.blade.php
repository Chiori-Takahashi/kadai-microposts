<ul class="nav nav-tabs nav-justified mb-3">
    ...
    <li class="nav-item"><a href="{{ route('users.favorites', ['id' => $user->id]) }}" class="nav-link {{ Request::is('microposts/*/favorites') ? 'activ' : '' }}">Favorites <span class="badge badge-secondary">{{ $count_favorites }}</span></span></a></li>
</ul>
